...
const upUserFormHandler = async (event) => {
    ...
    if (!password.length) {
        alert('Enter current password to confirm changes or enter new password');
        return
    } else {
...
document.addEventListener('submit', upUserFormHandler);